...
public class HotZoneController {
     ...
     * Request Body:
     * {
     *   "messageThreshold": 50,      // Minimum messages to be considered hot (default: 50)
     ...
     */
    @PostMapping
    public CompletableFuture<ResponseEntity<ApiResponse>> getHotZones(@RequestBody(required = false) HotZoneRequest request) {
        ...
        return hotZoneService.getHotZones(request)
                ...
                .exceptionally(ex -> {
                    ...
                    return ResponseEntity.badRequest()
                            .body(ApiResponse.error("Failed to fetch hot zones: " + ex.getMessage()));
                });
    }
    ...
    public CompletableFuture<ResponseEntity<ApiResponse>> getNearbyHotZones(@RequestBody HotZoneRequest request) {
        ...
        return hotZoneService.getHotZones(request)
                ...
                .exceptionally(ex -> {
                    ...
                    return ResponseEntity.badRequest()
                            .body(ApiResponse.error("Failed to fetch nearby hot zones: " + ex.getMessage()));
                });
    }
     ...
     * 
     * Example:
     * curl http://localhost:8080/api/hotzones/tower/RwvBgwnDbPsupDsZ7rH1?messageThreshold=50
     */
        ...
        return hotZoneService.getTowerHotZoneStatus(towerId, messageThreshold)
                .thenApply(response -> {
                    ...
                    log.info("Tower {} is {} with {} messages", 
                            towerId, response.getActivityLevel(), response.getMessageCount());
                ...
                .exceptionally(ex -> {
                    ...
                    return ResponseEntity.badRequest()
                            .body(ApiResponse.error("Failed to check tower status: " + ex.getMessage()));
                });
    }
    ...
    public CompletableFuture<ResponseEntity<ApiResponse>> getHotZonesStats(
        ...
        return hotZoneService.getHotZones(request)
                ...
                .exceptionally(ex -> {
                    ...
                    return ResponseEntity.badRequest()
                            .body(ApiResponse.error("Failed to fetch stats: " + ex.getMessage()));
                });
    }
}
