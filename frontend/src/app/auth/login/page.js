      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to continue exploring</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/auth/signup" className="font-semibold underline underline-offset-4 hover:text-black dark:hover:text-white">
                Sign Up
              </Link>
            </p>
          </CardContent>
